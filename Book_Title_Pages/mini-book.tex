...
\usepackage[nomath]{libertinus} % Use the Paratype Serif font
...
\begin{titlepage} % Suppresses headers and footers on the title page
  ...
  \textbf{\LARGE 一本非常厚的}\\[\baselineskip] % First title line

  {\textcolor{Red}{\Huge Lua\LaTeX{}範本書}}\\[\baselineskip] % Main title line which draws the focus of the reader

  {\Large \textit{內容豐富}} % Subtitle
  ...
  {\large 左右手互擊出版社~~\plogo} % Publisher and logo
