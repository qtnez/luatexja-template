...
%\usepackage{microtype} % Improved typography 中文不需要
...
\usepackage[nomath]{libertinus}  % 英數字使用 Libertinus 字型
...
\usepackage[colorlinks=true, linkcolor=altncolor, anchorcolor=altncolor,
            citecolor=altncolor, filecolor=altncolor, menucolor=altncolor,
            urlcolor=altncolor]{hyperref} % Use the color defined above for all links
...
\newcommand{\BackToContents}{\hyperlink{contents}{{\small 回目錄}}} % Define a command for linking back to the contents of the newsletter
